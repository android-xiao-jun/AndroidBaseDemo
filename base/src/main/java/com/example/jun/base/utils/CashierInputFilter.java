...
public class CashierInputFilter implements InputFilter {
    ...
    public final static int LENGTH_4 = 4;
    public final static int LENGTH_2 = 2;

    public static void setCashierInputFilter(EditText editText, int length) {
        InputFilter[] filters = editText.getFilters();
        InputFilter[] inputFilters = Arrays.copyOf(filters, filters.length + 1);
        inputFilters[(inputFilters.length - 1)] = new CashierInputFilter(length);
    ...
    //小数点后的位数
    private int POINTER_LENGTH = 20;

    private static final String POINTER = ".";

    private static final String ZERO = "0";

    public CashierInputFilter(int length) {
